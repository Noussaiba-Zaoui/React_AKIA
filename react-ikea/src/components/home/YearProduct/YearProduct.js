...
const YearProduct = () => {
  return (
    <Link to="/montage">
      <div className="w-full h-80 mb-8 md:mb-40 bg-[#f3f3f3] md:bg-transparent relative font-titleFont flex flex-col md:flex-row">
        <Image
          className="max-w-full h-auto object-contain md:w-1/3 md:h-cover md:object-right"
          imgSrc={montagepic}
        />
        <div className="w-full md:w-2/3 xl:w-1/2 h-80 absolute px-4 md:px-8 lg:px-12 top-0 right-0 flex flex-col items-start gap-6 justify-center">
